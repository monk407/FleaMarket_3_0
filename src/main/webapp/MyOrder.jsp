...
<head>
    ...
    <script type="text/javascript" src="js/MyOrder.jsp.js"></script>
...
<div class="container w">
    ...
    <div class="show_myorders_nav">
        <ul>
            ...
            <li>
                <div class="myorders_operation_nav">
                    <p>我的订单操作</p>
                </div>
            </li>
        </ul>
    ...
    <!-- 商品详情 -->
<div id="MyBuyGoodsDetail">
<%--    <div class="show_myorders">--%>
<%--        <ul>--%>
<%--            <li>--%>
<%--                <div class="good_id">--%>
<%--                    <!-- <p></p> -->--%>
...
<%--            <li>--%>
<%--                <div class="myorders_operation">--%>
<%--                    <button type="submit" class="right"></a>确认收获</button>--%>
<%--                </div>--%>
<%--            </li>--%>
<%--        </ul>--%>
<%--    </div>--%>
...
<%--    </div>--%>
    ...
    <div class="container foot_font">
        <p>www.FleaMarket.com © All rights Reseverd</p>
    </div>
</div>
